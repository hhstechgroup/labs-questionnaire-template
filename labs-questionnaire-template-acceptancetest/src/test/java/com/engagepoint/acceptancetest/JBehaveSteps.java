...
public class JBehaveSteps {
    ...
    @Given("name of row")
    public void givenRowName(@Named("rowName") String rowName) {
        this.rowName = rowName;
    }

    @Given("name of column")
    public void givenColumnName(@Named("columnName") String columnName) {
    ...
    @When("the user fills '$id' field with row name")
    public void fillFieldWithRowName(String id) {
        uIBootstrapBasePage.enter(rowName).intoField(jbehaveBase.findVisibleElementAndGetSelector(id));
    }

    @When("the user fills '$id' field with column name")
    public void fillFieldWithColumnName(String id) {
        uIBootstrapBasePage.enter(columnName).intoField(jbehaveBase.findVisibleElementAndGetSelector(id));
    }
    ...
    @When("in table '$tableId' user fills name of new option with <option name>")
    public void whenInTableChoosesRowWithText(String tableId) {
        WebElement tableElement = getTableElement(tableId);
        WebElement option = tableElement.findElement(By.xpath(".//td[.//*[contains(text(),'New')]]"));
        option.click();

        WebElement optionInput = tableElement.findElement(By.xpath(".//*[.//*[contains(text(),'New')]]/div/div/input"));
        uIBootstrapBasePage.element(optionInput).typeAndTab(optionName);
    }
    ...
    public void thenInTableThereIsOptionName(String tableId) {
        /*WebElement tableElement = getTableElement(tableId);
        WebElement row = tableElement.findElement(By.xpath("//*[.//*[contains(text(),'"+optionName+"')]]//button[//contains(text(),'Delete')]"));

...
User can select "Checkboxes in the
...
When the user fills 'formTemplate:name' field with 'LQE-11 test'
...
Then wait until all animations on page completed
When choose 'CHECKBOX' from drop-down
...
Scenario:
User can define name(s) for check
boxes.

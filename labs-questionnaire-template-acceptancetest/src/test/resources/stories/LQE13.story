...
I want to add “Range" questions to question groups so that the template meets my needs.
...
Scenario:
User can select "Range" in the Question Type drop-down list.
...
Scenario:
User can define min and max values for the range.

...
"Choose from a list" questions to question groups so
that the template meets my needs.


GivenStories: base_stories/openDefaultPage.story
Scenario: create and fill
Meta: @testName         LQE-12
      @sectionName      Page 1
      @groupName        Group 1
      @questionType     CHOOSEFROMLIST
      @questionText     Question text LQE-12
      @helpText         Help text LQE-12
...
Scenario: edit
Meta: @questionText     Question text LQE-12 edit
      @helpText         Help text LQE-12 edit
      @optionName       Test option 3
...
Meta: @testName         LQE-12
      ...
      @groupName        Group 1
      @questionName     Question ...
      @questionText     Question text LQE-12 edit
      @helpText         Help text LQE-12 edit
      @optionName       Test option 3
GivenStories: base_stories/question/saveQuestion.story,
              base_stories/template/saveTemplate.story,

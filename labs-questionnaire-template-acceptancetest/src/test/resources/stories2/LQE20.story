...
When 'questionForm:form4:fileupload:qtext' field with 'i believe i can fly'
When 'questionForm:form4:fileupload:helpText' field with 'I believe I can touch the sky'

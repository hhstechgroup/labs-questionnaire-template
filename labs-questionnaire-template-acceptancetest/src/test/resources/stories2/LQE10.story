...
User can select "Multiple Choice" in the Q
uestion Type drop-down list.
When the user opens the default page
When clicks on element with id/name/className 'form1:AddTemplate'
Then should open page with 'Template Editor' title
When the user fills 'formTemplate:name' field with 'LQE-10 test'
...
Then wait until all animations on page completed
When choose 'MULTIPLECHOICE' from drop-down

...
public class TemplateBeanTest {
    ...
    public void testCloneTemplateBean() throws Exception {
        ...
        TemplateBean testTemplate = new TemplateBean("Questonnaire",sectionsList);
    ...
    public void testEqualityTemplates(){
        ...
        sectionsList.add(section1);
        sectionsList.add(section2);
        TemplateBean testTemplate = new TemplateBean("Questionnaire",sectionsList);
        ...
        TemplateBean testTemplate1 = new TemplateBean("Questionnaire",sectionsList1);
